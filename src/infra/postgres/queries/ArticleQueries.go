...
func (articleSelectSqlManager) In(numberOfArticles int) string {
	...
	return fmt.Sprintf(`SELECT article.id AS article_id, article.created_at AS article_created_at,
				...
				COALESCE(voting.result_announced_at, '1970-01-01 00:00:00') AS voting_result_announced_at,
				COALESCE(voting.is_approved, false) AS voting_is_approved,
				...
				COALESCE(event.starts_at, '1970-01-01 00:00:00') AS event_starts_at,
				COALESCE(event.ends_at, '1970-01-01 00:00:00') AS event_ends_at,

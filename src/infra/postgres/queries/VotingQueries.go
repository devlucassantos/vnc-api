...
func (votingSelectSqlManager) ByArticleId() string {
	return `SELECT article.id AS article_id, article.created_at AS article_created_at,
				...
				voting.result_announced_at AS voting_result_announced_at, voting.is_approved AS voting_is_approved,
				voting.main_proposition_id AS voting_main_proposition_id,

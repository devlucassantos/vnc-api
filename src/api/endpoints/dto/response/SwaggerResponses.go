...
type SwaggerPropositionArticle struct {
	...
	UserRating        int                     `json:"user_rating"         example:"5"`
	ViewLater         bool                    `json:"view_later"          example:"true"`
	NewsletterArticle SwaggerArticle          `json:"newsletter_article"`
...
type SwaggerExternalAuthor struct {
...
type SwaggerUser struct {
	...
	CreatedAt    time.Time `json:"created_at"    example:"2022-09-23T18:20:00Z"`
	UpdatedAt    time.Time `json:"updated_at"    example:"2022-09-23T18:20:00Z"`
}
